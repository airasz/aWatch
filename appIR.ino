...
void drawSelectBrand()
{
        ...
        drawSmoothOutlineButton(0, 130, 60, 40, COLOR_ACCENT[config.colorAccent], TFT_WHITE, "Pana");
        drawSmoothOutlineButton(240 - 62, 130, 60, 40, COLOR_ACCENT[config.colorAccent], TFT_WHITE, "LG");
}
void drawACremote()
{
        ...
        drawButton(161, 190, 78, 40, COLOR_ACCENT[config.colorAccent], TFT_BLACK, "SEND");
